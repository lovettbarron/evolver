...
// Placeholder — hand-place from manual reference image when Phase 28 panel renderer is ready
export const CONTROL_POSITIONS: Record<string, { x: number; y: number }> = {
  // Channel 1
  'knob-ch1-rise': { x: 0, y: 0 },
  'knob-ch1-fall': { x: 0, y: 0 },
  'knob-ch1-vari-response': { x: 0, y: 0 },
  'knob-ch1-attenuverter': { x: 0, y: 0 },
  'button-ch1-cycle': { x: 0, y: 0 },
  'led-ch1-cycle': { x: 0, y: 0 },
  'led-ch1-unity': { x: 0, y: 0 },
  'led-ch1-eor': { x: 0, y: 0 },
  'jack-ch1-signal-in': { x: 0, y: 0 },
  'jack-ch1-trig-in': { x: 0, y: 0 },
  'jack-ch1-rise-cv-in': { x: 0, y: 0 },
  'jack-ch1-fall-cv-in': { x: 0, y: 0 },
  'jack-ch1-both-cv-in': { x: 0, y: 0 },
  'jack-ch1-cycle-in': { x: 0, y: 0 },
  'jack-ch1-unity-out': { x: 0, y: 0 },
  'jack-ch1-eor-out': { x: 0, y: 0 },
  'jack-ch1-var-out': { x: 0, y: 0 },
  // Channel 2
  'knob-ch2-attenuverter': { x: 0, y: 0 },
  'jack-ch2-signal-in': { x: 0, y: 0 },
  'jack-ch2-var-out': { x: 0, y: 0 },
  // Channel 3
  'knob-ch3-attenuverter': { x: 0, y: 0 },
  'jack-ch3-signal-in': { x: 0, y: 0 },
  'jack-ch3-var-out': { x: 0, y: 0 },
  // Channel 4
  'knob-ch4-rise': { x: 0, y: 0 },
  'knob-ch4-fall': { x: 0, y: 0 },
  'knob-ch4-vari-response': { x: 0, y: 0 },
  'knob-ch4-attenuverter': { x: 0, y: 0 },
  'button-ch4-cycle': { x: 0, y: 0 },
  'led-ch4-cycle': { x: 0, y: 0 },
  'led-ch4-unity': { x: 0, y: 0 },
  'led-ch4-eoc': { x: 0, y: 0 },
  'jack-ch4-signal-in': { x: 0, y: 0 },
  'jack-ch4-trig-in': { x: 0, y: 0 },
  'jack-ch4-rise-cv-in': { x: 0, y: 0 },
  'jack-ch4-fall-cv-in': { x: 0, y: 0 },
  'jack-ch4-both-cv-in': { x: 0, y: 0 },
  'jack-ch4-cycle-in': { x: 0, y: 0 },
  'jack-ch4-unity-out': { x: 0, y: 0 },
  'jack-ch4-eoc-out': { x: 0, y: 0 },
  'jack-ch4-var-out': { x: 0, y: 0 },
  // Buses
  'jack-or-out': { x: 0, y: 0 },
  'jack-sum-out': { x: 0, y: 0 },
  'jack-inv-out': { x: 0, y: 0 },
  'led-sum-pos': { x: 0, y: 0 },
  'led-sum-neg': { x: 0, y: 0 },
};
...
export const SECTION_BOUNDS: Record<string, { x: number; y: number; width: number; height: number }> = {
  'ch1': { x: 0, y: 0, width: 100, height: 100 },
  'ch2': { x: 0, y: 0, width: 100, height: 100 },
  'ch3': { x: 0, y: 0, width: 100, height: 100 },
  'ch4': { x: 0, y: 0, width: 100, height: 100 },
  'buses': { x: 0, y: 0, width: 100, height: 100 },
};
