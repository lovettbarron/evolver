...
**Plans**: 2 plans
Plans:
- [ ] 21-01-PLAN.md — CSS foundation: .card base class, :focus-visible global, editorial prose rules
- [ ] 21-02-PLAN.md — Component className migration + visual checkpoint
**UI hint**: yes
...
| 21. Cards & Content Components | v1.3 | 1/2 | In Progress | 2026-04-11 |
