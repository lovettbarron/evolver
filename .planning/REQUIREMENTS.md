...
- [x] **PANEL-05**: Hand-placed SVG panel for Mannequins Just Friends (14HP, modulator/VCO/EG)
- [x] **PANEL-06**: Hand-placed SVG panel for Monome Crow (2HP, scriptable I/O)
...
- [x] **CURR-04**: Just Friends curriculum (8-10 sessions for Shape/Cycle/Sound modes)
- [x] **CURR-05**: Crow curriculum (4-6 sessions for scripting, i2c, standalone I/O)
