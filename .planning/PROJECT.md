...
**Reference materials**: Two PDFs in `references/`:
1. `Evo_Key_Manual_1.3.pdf` — Official DSI operation manual (parameters, MIDI, sysex)
2. `evolverguide.pdf` — "The Definitive Guide to Evolver" by Anu Kirk (pedagogical, exercise-based with a "basic patch" approach)
...
**Instruments**:
- Dave Smith Mono Evolver keyboard (active — 7/35 sessions written)
- Intellijel Cascadia (planned — will validate framework extensibility)
